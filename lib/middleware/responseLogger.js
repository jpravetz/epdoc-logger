...
var ResponseLogger = {
    ...
    /**
     * Replace express's res.send() method with our own, so that we can add a couple of logging methods, but then
...
// Not used
     ...
     * Looks for sessionID in req.session.id or req.sessionId.
     * This is the method that calls the underlying logging outputer. If you want to use your own logging tool,
     * you can replace this method or replace Logger.
     * @param params
     * @return {*}
     */

 ...
 * @param msgParams includes level, sessionId, module, time, timeDiff, msg
 */
module.exports.writeMessage = writeMessageParams;
...
function writeLoggerMessage( level, msg ) {
    var tnow = new Date();
...
module.exports.setLogger = function( name, options ) {
    ...
    if( bValid ) {
        ...
        writeLoggerMessage( "error", "Unsupported setLogger operation " + name + ( options ? (" " + JSON.stringify(options)) : "" )
